...
export class SubcategoryService {
  ...
  async create(createSubcategoryDto: CreateSubcategoryDto) {
    try {
      const { subcategoryName, catalog_id, category_id } =
      ...
      const data = this.repo.create({ subcategoryName, catalog, category });
  ...
  async update(id: number, updateSubcategoryDto: UpdateSubcategoryDto) {
    try {
      ...
      await this.repo.update({ id }, { subcategoryName, catalog, category });
